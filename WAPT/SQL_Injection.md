...
- Parametri- Parametri forniti nel body della richiesta dell'utente in una richiesta post. forniti nel body della richiesta dell'utente in una richiesta post.
...
**NOTA**: **URLs cannot contain spaces**. URL encoding normally replaces a space with a plus (+) sign or with %20.